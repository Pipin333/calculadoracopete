...
// ===============================
const mockProducts = [
  { id: 1, categoria: "cerveza", nombre: "Cerveza Lager lata 470cc", tienda: "Lider", precio: 1690, unidades: 1, volumenMlUnidad: 470 },
  { id: 2, categoria: "cerveza", nombre: "Cerveza Lager six pack 6x330cc", tienda: "Lider", precio: 6990, unidades: 6, volumenMlUnidad: 330 },
  { id: 3, categoria: "cerveza", nombre: "Cerveza Lager maletín 12x330cc", tienda: "Lider", precio: 13990, unidades: 12, volumenMlUnidad: 330 },

  { id: 4, categoria: "cerveza", nombre: "Cerveza Lager lata 710cc", tienda: "Jumbo", precio: 2490, unidades: 1, volumenMlUnidad: 710 },
  { id: 5, categoria: "cerveza", nombre: "Cerveza Lager six pack 6x470cc", tienda: "Jumbo", precio: 11990, unidades: 6, volumenMlUnidad: 470 },
  { id: 6, categoria: "cerveza", nombre: "Cerveza Lager caja 24x330cc", tienda: "Jumbo", precio: 26990, unidades: 24, volumenMlUnidad: 330 },

  { id: 7, categoria: "cerveza", nombre: "Cerveza Lager botellín 660cc", tienda: "Unimarc", precio: 2290, unidades: 1, volumenMlUnidad: 660 },
  { id: 8, categoria: "cerveza", nombre: "Cerveza Lager maletín 12x330cc", tienda: "Unimarc", precio: 14490, unidades: 12, volumenMlUnidad: 330 },

  { id: 20, categoria: "piscola", nombre: "Pisco 750ml", tienda: "Lider", precio: 6990, unidades: 1, volumenMlUnidad: 750 },
  { id: 21, categoria: "piscola", nombre: "Pisco 1L", tienda: "Lider", precio: 9290, unidades: 1, volumenMlUnidad: 1000 },

  { id: 22, categoria: "piscola", nombre: "Pisco 750ml", tienda: "Jumbo", precio: 6790, unidades: 1, volumenMlUnidad: 750 },
  { id: 23, categoria: "piscola", nombre: "Pisco 1L", tienda: "Jumbo", precio: 9490, unidades: 1, volumenMlUnidad: 1000 },
  ...
  { id: 52, categoria: "bebida", nombre: "Bebida cola 1.5L", tienda: "Jumbo", precio: 1890, unidades: 1, volumenMlUnidad: 1500 },
  { id: 53, categoria: "bebida", nombre: "Bebida cola 2L", tienda: "Jumbo", precio: 2490, unidades: 1, volumenMlUnidad: 2000 },
    ...
    col.innerHTML = `
      <div class="border rounded p-3 bg-white">
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <span id="sliderValue_${drink}" class="fw-semibold">${initialValue}%</span>
        </div>
        <input
          type="range"
...
function handleSliderInput(e) {
  ...
  document.getElementById(`sliderValue_${drink}`).textContent = `${e.target.value}%`;
  updateBudgetSplitState();
}

function getBudgetSplit() {
  const sliders = Array.from(document.querySelectorAll(".budget-slider"));
  const split = {};

  sliders.forEach(slider => {
    split[slider.dataset.drink] = parseInt(slider.value, 10);
  });
